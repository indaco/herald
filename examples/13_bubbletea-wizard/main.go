// Multi-step project scaffolder wizard using herald with huh and bubbletea.
//
// This example is a separate Go module with its own go.mod to keep
// charm.land/bubbletea/v2 and charm.land/huh/v2 out of herald's core
// dependencies.
//
// Run from the repository root:
//
//	cd examples/13_bubbletea-wizard && go run .
package main
